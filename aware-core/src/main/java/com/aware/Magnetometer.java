 ...
 */
public class
Magnetometer extends Aware_Sensor implements SensorEventListener {
    ...
    public void onDestroy() {
        ...
        if (shouldDeleteDatabase) {
            getContentResolver().delete(Uri.parse("content://" + Magnetometer_Provider.AUTHORITY + "/" + DatabaseHelper.DROP_TABLE_URI), null, null);
        }
